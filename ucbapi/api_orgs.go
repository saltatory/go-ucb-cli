...
*/
func (a *OrgsApiService) GetBillingPlans(ctx _context.Context, orgid string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/orgs/{orgid}/billingplan"
...
@return map[string]interface{}
*/
func (a *OrgsApiService) GetSSHKey(ctx _context.Context, orgid string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/orgs/{orgid}/sshkey"
	localVarPath = strings.Replace(localVarPath, "{"+"orgid"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", orgid)), -1)
...
@return map[string]interface{}
*/
func (a *OrgsApiService) RegenerateSSHKey(ctx _context.Context, orgid string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
