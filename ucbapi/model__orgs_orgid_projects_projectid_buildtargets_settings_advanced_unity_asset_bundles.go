...
package ucbapi
// OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAssetBundles struct for OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAssetBundles
type OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAssetBundles struct {
	// enable asset bundle builds for this target
	BuildBundles bool `json:"buildBundles,omitempty"`
