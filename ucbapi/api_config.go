...
@return []string
*/
func (a *ConfigApiService) ListScmsSupportingVersionAutoDetect(ctx _context.Context) ([]string, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/versions/auto_detect_supported_scms"
...
*/
func (a *ConfigApiService) ListUnityVersions(ctx _context.Context) ([]InlineResponse200, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/versions/unity"
...
*/
func (a *ConfigApiService) ListXcodeVersions(ctx _context.Context) ([]InlineResponse2001, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/versions/xcode"
