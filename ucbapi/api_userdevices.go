...
// UserdevicesApiService UserdevicesApi service
type UserdevicesApiService service
...
*/
func (a *UserdevicesApiService) CreateDevice(ctx _context.Context, options InlineObject1) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users/me/devices"
...
*/
func (a *UserdevicesApiService) ListDevicesForUser(ctx _context.Context) ([]InlineResponse2003, *_nethttp.Response, error) {
	var (
