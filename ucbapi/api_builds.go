...
@return map[string]interface{}
*/
func (a *BuildsApiService) GetBuild(ctx _context.Context, orgid string, projectid string, buildtargetid string, number string, localVarOptionals *GetBuildOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
