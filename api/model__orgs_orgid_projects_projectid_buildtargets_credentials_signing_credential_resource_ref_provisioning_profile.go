...
package ucbapi
// OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile struct for OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile
type OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile struct {
	...
	IsEnterpriseProfile bool `json:"isEnterpriseProfile,omitempty"`
	Type string `json:"type,omitempty"`
	// number of devices provisioned for this certificate
	NumDevices float32 `json:"numDevices,omitempty"`
	// uploaded date
