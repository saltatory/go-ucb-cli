...
*/
func (a *UsersApiService) GetUserApiKey(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users/me/apikey"
...
// GetUserSelfOpts Optional parameters for the method 'GetUserSelf'
type GetUserSelfOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetUserSelfOpts - Optional Parameters:
 * @param "Include" (optional.String) -  Extra fields to include in the response
@return map[string]interface{}
*/
func (a *UsersApiService) GetUserSelf(ctx _context.Context, localVarOptionals *GetUserSelfOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *UsersApiService) RegenApiKey(ctx _context.Context) (InlineResponse2002, *_nethttp.Response, error) {
	var (
...
// UpdateUserSelfOpts Optional parameters for the method 'UpdateUserSelf'
type UpdateUserSelfOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UpdateUserSelfOpts - Optional Parameters:
 * @param "Options" (optional.Interface of InlineObject) - 
@return map[string]interface{}
*/
func (a *UsersApiService) UpdateUserSelf(ctx _context.Context, localVarOptionals *UpdateUserSelfOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Options.IsSet() {
		localVarOptionalOptions, localVarOptionalOptionsok := localVarOptionals.Options.Value().(InlineObject)
		if !localVarOptionalOptionsok {
			return localVarReturnValue, nil, reportError("options should be InlineObject")
		}
